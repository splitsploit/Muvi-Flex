            ...
            <div class="grid grid-cols-2 gap-5 xl:gap-12">
                    ...
                    <div class="col-span-1 relative overflow-hidden group">
                        ...
                        <div
                            ...
                            <div class="px-7 pb-7">
                                <div class="font-medium text-xl text-white">Avatar</div>
                        ...
                        <div class="absolute top-1/2 left-1/2 -translate-y-[500px] group-hover:-translate-y-1/2
                            ...
                            <img src="{{ asset('muvi-flex/assets/images/ic_play.svg') }}" class="" width="80" alt="">
                        </div>
                        <a href="#" class="inset-0 absolute z-50"></a>
                    </div>
                    <div class="col-span-1 relative overflow-hidden group">
                        <img src="{{ asset('muvi-flex/assets/images/featured-2.png') }}" class="object-cover rounded-[30px]" alt="">
                        <div
                            class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent">
                            <div class="px-7 pb-7">
                                <div class="font-medium text-xl text-white">Julian Odette</div>
                                <p class="mb-0 text-stream-gray text-base mt-[10px]">
                                    Julian Odette Adventure
                                </p>
                            </div>
                        </div>
                        <div class="absolute top-1/2 left-1/2 -translate-y-[500px] group-hover:-translate-y-1/2
    ...
    <div>
        ...
        <div class="watched-movies hidden">
            ...
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="{{ asset('muvi-flex/assets/images/film-5.png') }}"
            ...
            <!-- Movies 2 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="{{ asset('muvi-flex/assets/images/film-4.png') }}"
                    class="object-cover rounded-[30px] w-full h-[300px] w-[240px]" alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent overflow-hidden">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 3 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="{{ asset('muvi-flex/assets/images/film-3.png') }}"
                    class="object-cover rounded-[30px] w-full h-[300px] w-[240px]" alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent overflow-hidden">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 4 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="{{ asset('muvi-flex/assets/images/film-2.png') }}"
                    class="object-cover rounded-[30px] w-full h-[300px] w-[240px]" alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent overflow-hidden">
                    <div class="px-7 pb-7">
            ...
            <!-- Movies 5 -->
            <div class="relative group overflow-hidden mr-[30px]">
                <img src="{{ asset('muvi-flex/assets/images/film-1.png') }}"
                    class="object-cover rounded-[30px] w-full h-[300px] w-[240px]" alt="">
                <div
                    class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] z-10 translate-y-0 group-hover:translate-y-[300px] transition ease-in-out duration-500 group-hover:bg-transparent overflow-hidden">
                    <div class="px-7 pb-7">
