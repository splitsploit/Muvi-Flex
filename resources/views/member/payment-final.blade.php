...
<head>
    ...
    <title>Muvi Flex | Payment Success</title>
...
<body class="bg-stream-dark">
    ...
    <div class="font-poppins flex relative pt-20 px-3 h-screen">
        ...
        <span class="fixed -z-10 top-0 left-0">
            <img src="{{ asset('muvi-flex/assets/images/success_ellipse_green.svg') }}" alt="muvi-flex" />
        </span>
        <span class="fixed -z-10 bottom-0 right-0">
            <img src="{{ asset('muvi-flex/assets/images/success_ellipse_red.svg') }}" alt="muvi-flex" />
        </span>
        <!-- ./ -->
        ...
        <div class="flex flex-col items-center m-auto pb-20">
            ...
            <div>
                <a href="{{ route('member.dashboard') }}" class="py-3 px-[54px] text-center rounded-full bg-indigo-600">
