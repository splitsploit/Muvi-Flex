...
<body class="bg-stream-dark">
    ...
    <div class="relative">
        <div class="hidden lg:block fixed">
            <img src="{{ asset('muvi-flex/assets/images/banner.png') }}" class="max-h-screen" alt="muvi-flex" />
        </div>
    </div>
    ...
    <div class="grid md:grid-cols-12 font-poppins relative pb-20 pt-8 mx-auto max-w-screen overflow-hidden">
        ...
        <span class="fixed -z-10 top-0">
            <img src="{{ asset('muvi-flex/assets/images/pricing_ornament.svg') }}" class="h-screen w-screen" alt="muvi-flex" />
        </span>
        <!-- ./ -->
            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="{{ route('member.login.post') }}" method="POST" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf
